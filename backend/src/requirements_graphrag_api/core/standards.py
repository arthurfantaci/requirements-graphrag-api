...
async def lookup_standard(
    ...
    *,
    ...
    def _find_standard() -> dict[str, Any] | None:
    ...
    response = await asyncio.to_thread(_find_standard)
    ...
    if include_related:
        ...
        def _get_related() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
            with driver.session() as session:
                ...
                mentioned = [{"title": a["title"], "url": a["url"]} for a in articles_result]
    ...
    logger.info("Found standard: '%s'", response["name"])
    return response
...
async def search_standards(
    ...
    *,
    ...
    standards = await asyncio.to_thread(_search)
...
async def get_standards_by_industry(
    ...
    *,
    ...
    result_list = await asyncio.to_thread(_query)
...
async def list_all_standards(
    ...
    *,
    ...
    standards = await asyncio.to_thread(_query)
