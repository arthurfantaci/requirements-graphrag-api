...
class TestVectorSearchEndpoint:
    ...
    def test_vector_search_success(
        ...
        with patch("requirements_graphrag_api.routes.search.vector_search") as mock_search:
...
class TestHybridSearchEndpoint:
    ...
    def test_hybrid_search_success(
        ...
        with patch("requirements_graphrag_api.routes.search.hybrid_search") as mock_search:
            mock_search.return_value = sample_search_results
...
class TestGraphSearchEndpoint:
    ...
    def test_graph_search_success(
        ...
        with patch("requirements_graphrag_api.routes.search.graph_enriched_search") as mock_search:
